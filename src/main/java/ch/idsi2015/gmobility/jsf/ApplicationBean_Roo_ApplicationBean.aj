...
import ch.idsi2015.gmobility.jsf.ApplicationBean;
...
privileged aspect ApplicationBean_Roo_ApplicationBean {
    ...
    public void ApplicationBean.init() {
        ...
        submenu = new Submenu();
        submenu.setId("itineraireSubmenu");
        submenu.setLabel("Itineraire");
        item = new MenuItem();
        item.setId("createItineraireMenuItem");
        item.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{messages.label_create}", String.class));
        item.setActionExpression(expressionFactory.createMethodExpression(elContext, "#{itineraireBean.displayCreateDialog}", String.class, new Class[0]));
        ...
        item = new MenuItem();
        item.setId("listItineraireMenuItem");
        item.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{messages.label_list}", String.class));
        item.setActionExpression(expressionFactory.createMethodExpression(elContext, "#{itineraireBean.displayList}", String.class, new Class[0]));
